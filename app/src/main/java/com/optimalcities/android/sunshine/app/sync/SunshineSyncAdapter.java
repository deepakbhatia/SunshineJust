package com.optimalcities.android.sunshine.app.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                previous = getContext().getContentResolver().delete(WeatherContract.WeatherEntry.CONTENT_URI,
    ...
    private void notifyWatch(){
        ...
        if (cursor.moveToFirst()) {
            ...
            putDMR.getDataMap().putAsset(KEY_WEATHER_ICON, createAssetFromBitmap(largeIcon));
            putDMR.getDataMap().putString(KEY_HIGH_WEATHER_TEMP, Utility.formatTemperature(getContext(), high));
            ...
            //if(previous == 0)
            currentRequest = putDMR.setUrgent();

            PutDataRequest putDataReq = currentRequest.asPutDataRequest();
