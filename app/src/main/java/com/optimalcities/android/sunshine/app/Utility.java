...
public class Utility {
    ...
    int getLocationStatus(Context c)
    {
        ...
        return sp.getInt(c.getString(R.string.pref_location_status_key),SunshineSyncAdapter.LOCATION_STATUS_UNKOWN);
    }
    /**
    ...
    static public void resetLocationStatus(Context c){
        ...
        spe.putInt(c.getString(R.string.pref_location_status_key), SunshineSyncAdapter.LOCATION_STATUS_UNKOWN);
        spe.apply();
    }
}